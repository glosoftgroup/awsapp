...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :app do |app|
      app.vm.network :private_network, ip: "10.0.0.30"
      app.vm.network :forwarded_port, guest: 5555, host: 5750
      app.vm.provision :shell, :path => "devops/boostrap.sh"
  end
  ...
  #config.vm.synced_folder './devops/', '/vagrant/devops/ansible_devops',
